...
/**
 * Returns information about the user's browser and version.
 * Works in the browser only (returns null on the server).
 */
export default function getUserBrowser(): BrowserInfo | null {
